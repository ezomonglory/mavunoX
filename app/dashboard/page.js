		...
		<Dashlayout weather={weather}>
			<div className='md:flex items-center justify-between mb-[44px] hidden  '>
				<div className='flex items-center space-x-[8px]'>
					<span> {locationBold} </span>
					<h2 className='text-[#5B5B5B] text-[16px] capitalize tracking-[-0.1px] neue400 leading-[24px] '>
						{userData?.state}, {userData?.country}
					</h2>
				</div>
				<div className='flex space-x-[16px] items-center '>
					<h2 className='text-[#5B5B5B] text-[16px] tracking-[-0.1px] neue400 leading-[24px] '>
						{date}
					</h2>
					<hr className='bg-[#E4E4E4] h-[40px] w-[1px] ' />
			...
			<div>
				...
				<div className='bg-[#FCF1E9] rounded-[6px] py-[8px] px-[16px] hidden sm:block border border-[#8B4513] mt-[16px] '>
					<h1 className='text-[#8B4513] text-[16px] leading-[24px] tracking-[-0.1px] neue400 '>
						...
						<span className='capitalize'>{userData?.fullname}</span>! It is
						prime time to sow the seeds of a bountiful harvest. Now, let us{" "}
						<br /> seize the season and plant some winter wonders together
					</h1>
				</div>
			</div>
			...
			<div className='mt-[32px] border rounded-[8px] w-screen sm:w-full ml-[-16px] mr-[-16px] sm:mx-0 '>
				<div className='flex flex-col md:flex-row space-y-[24px] md:space-y-0 md:items-center justify-between border border-transparent border-b-[#e5e7eb] py-[12px] md:py-[20px] px-[16px] md:px-[24px]  '>
						...
						{showInfo && (
							<div className='bg-[#FCF1E9] rounded-[6px] py-[8px] px-[16px] absolute w-fit top-2 mx-auto sm:hidden border border-[#8B4513] left-0 '>
								<h1 className='text-[#8B4513] text-[16px] leading-[24px] tracking-[-0.1px] neue400 '>
									...
									is prime time to sow the seeds of a bountiful harvest. Now,
									let us <br /> seize the season and plant some winter wonders
									together
								</h1>
							</div>
						)}
						<div className='flex space-x-[4px] items-center'>
							<h1 className='text-[#141414] text-[18px] neue500 leading-[28px] tracking-[-0.1px] '>
								Prediction
							</h1>
							<span className='sm:hidden' onClick={()=>{setShowInfo(!showInfo)}}> {infoIcon} </span>
						</div>
					...
					<div
						className='flex items-center space-x-[4px] bg-[#049600] cursor-pointer py-[10px] pl-[12px] pr-[16px] rounded-[8px] w-fit'
						onClick={() => {
